...
export class Medico extends Funcionario{
    private crm:string
     constructor(nome:string,telefone:string,email:string, endereco:Endereco, genero:Genero, estadoCivil:EstadoCivil, dataNascimento:Date, cpf:string, rg:string,matricula:string,setor:Setor,salario:Decimal, crm:string){
